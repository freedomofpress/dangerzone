...
export DANGERZONE_LOCAL_IMAGE=1  # On Linux and macOS
set DANGERZONE_LOCAL_IMAGE 1  # On Windows
```
...
```
unset DANGERZONE_LOCAL_IMAGE  # On Linux and macOS
set DANGERZONE_LOCAL_IMAGE=  # On Windows
```
