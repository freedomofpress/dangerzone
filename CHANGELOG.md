...
- Build Qubes packages from tagged releases of the https://github.com/freedomofpress/dangerzone-image repo
...
- Move the code for the container image into a separate
...
- Make the `podman pull` command and registry lookups go through Tor on Tails ([#1335](https://github.com/freedomofpress/dangerzone/issues/1335))
- Add a startup task that installs WSL ([#1312](https://github.com/freedomofpress/dangerzone/issues/1312))
