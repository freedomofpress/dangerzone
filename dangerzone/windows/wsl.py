...
# In the following commands, we set the encoding to non-BOM UTF16, which is what WSL
# uses. If not set, stdout will contain invisible null characters which renders the
# output impossible to read and copy/paste.
# Note that this is not necessary for commands initiated with ShellExecuteEx, since they
