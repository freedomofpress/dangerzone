...
For users testing our [new Qubes integration (beta)](../how-to/install.md#qubes-os), please note that our instructions were missing a configuration detail for disposable VMs which is necessary to fully harden the configuration.
