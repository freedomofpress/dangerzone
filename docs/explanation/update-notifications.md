...
https://github.com/freedomofpress/dangerzone/wiki/Updates. The keys mentioned
below are documented in the [settings reference](../reference/settings.md),
and the independent sandbox update mechanism that this design was later
extended with is described in [Independent sandbox updates](sandbox-updates.md).
