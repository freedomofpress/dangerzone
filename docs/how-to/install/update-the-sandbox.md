...
The public key used to verify the container signatures is shipped in `share/freedomofpress-dangerzone.pub`, signed by our main Dangerzone release key. You can [verify this signature using `gpg`](verify-pgp-signatures.md).
