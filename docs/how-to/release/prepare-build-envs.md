...
- [ ] Update Python to the latest supported version, following our [instructions](manage-python-installations.md)
...
- Follow the [Windows build instructions](../contribute/build-from-source.md#windows), except:
